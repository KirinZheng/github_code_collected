...
pretrained = "/zhengzeqi/Githubs_code/Spike-Driven-Transformer-V3-main/SDT_V3/Detection/official_weights/T4_224_8_768_official_ckp_78.80.pth"  # QKFormer less 16.47M
...
model = dict(
    ...
    backbone=dict(
        _delete_=True,
        type='hierarchical_spiking_transformer_TFC',
        T=2,
        patch_size=16,
        in_channels=3, 
        embed_dims=384,
